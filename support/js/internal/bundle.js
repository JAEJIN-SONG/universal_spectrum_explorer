      ...
      function (require, module, exports) {
        ...
        Annotation = class Annotation {
          constructor(request) {
            ...
            this.C_TERMINUS =
              this.ChemistryConstants.O + this.ChemistryConstants.H;
            this.B_ION_TERMINUS = this.ChemistryConstants.Proton; // wiki
            this.A_ION_TERMINUS =
              this.B_ION_TERMINUS -
              this.ChemistryConstants.C -
              this.ChemistryConstants.O; // wiki
            this.C_ION_TERMINUS =
              (2 + 1) * this.ChemistryConstants.H +
              this.ChemistryConstants.N -
              this.ChemistryConstants.Proton;

            this.Y_ION_TERMINUS =
              this.ChemistryConstants.Proton +
              2 * this.ChemistryConstants.H +
              this.ChemistryConstants.O;
            this.X_ION_TERMINUS =
              this.ChemistryConstants.Proton +
              2 * this.ChemistryConstants.H +
              this.ChemistryConstants.O;
            this.Y_ION_TERMINUS =
              ...
              this.ChemistryConstants.O;
            this.NH3 =
              this.ChemistryConstants.H * 3 + this.ChemistryConstants.N;
            this.H2O =
              this.ChemistryConstants.H * 2 + this.ChemistryConstants.O;
            this.CO2 =
              this.ChemistryConstants.O * 2 + this.ChemistryConstants.C;
            ...
            this.peakData = request["peakData"]
              .sort(function (a, b) {
                return a.mZ < b.mZ;
              })
              .reduce((p, n) => {
                ...
                if (p[p.length - 1].mZ === n.mZ) {
                  var pp = p;
                  pp[pp.length - 1].intensity =
                    pp[pp.length - 1].intensity + n.intensity;
                  return pp;
                } else {
                  return p.concat(n);
                }
            ...
            this.peakData = this.peakData.map((el, i) => {
              return { mz: el["mZ"], intensity: el["intensity"] };
            });
            this.fragmentTypes = request.fragmentTypes;

            var max_peak = this.peakData.reduce((e, i) => {
              return e.intensity > i.intensity ? e : i;
            });
            ...
            this.precursorMz = this.calculatePrecursorMZ(
              request.sequence,
              request.precursorCharge,
              this.mods
            );
            this.response["isPPM"] = this.transformIsPPM(request);
            this.response["precursorMz"] = this.calculatePrecursorMZ(
              request.sequence,
              request.precursorCharge,
              this.mods
            );
            this.response["precursorMass"] = this.calculatePrecursorMass(
              request.sequence,
              this.mods
            );
            this.response["fragments"] = this.calculateFragments(
              request["sequence"],
              request["precursorCharge"],
              this.mods,
              request["fragmentTypes"]
            );
            this.allMassOffset = this.calculateAllMassOffset(this.mods);
            this.response["modifications"] = this.mods;
            this.sequence = request["sequence"];
            this.peaks = this.annotatePeaks();
            this.modifications = []; // this.generateModifications();
            this.modifications = new Array(this.sequence.length + 2)
              .fill(undefined)
              .map((e, i) => {
                return {
                  site: i - 1,
          ...
          annotatePeaks() {
            ...
            var compare_F = binary.compare_FACTORY(
              "mz",
              this.isPPM ? "ppm" : "Da",
              this.tolerance
            );
            ...
            var bla = this.response["fragments"]
              .map((el) => {
                // el are calculated frags
                ...
                var checkCharge = this.checkCharge(
                  el,
                  this.fragmentTypes.CustomCharge
                );
                if (
                  is_inside &&
                  a["matchedFeatures"].length < 1 &&
                  checkCharge
                ) {
                  a["matchedFeatures"].push({
                    feature: el,
                    massError:
                      ((a["mz"] - el["mz"]) / el["mz"]) * Math.pow(10, 6), // https://github.com/coongroup/IPSA/blob/0b5125a8923d1a1897b61c53390164e7e7c5d356/support/php/NegativeModeAnnotateEntireFile.php#L898
                  });
                  //set peakColor
            ...
            spectrum_1 = spectrum_1.map((el) => {
              ...
              if (
                el["percentBasePeak"] <= this.cutoff ||
                el["percentBasePeak"] >= this.cutoffMax
              ) {
                el["matchedFeatures"] = [];
              }
              return el;
          ...
          checkCharge(fragment, customCharge) {
            if (customCharge.selected == false) return true;
            else {
              if (fragment.charge == customCharge.charge) return true;
              else return false;
            }
          }
          ...
          calculateAminoSequenceMass(sequence) {
            ...
            const SequenceMass = aSequence
              .map((aS) => this.AminoAcids[aS])
              .reduce((a, b) => a + b, 0);
            return SequenceMass;
          }
          ...
          calculatePrecursorMass(sequence, mods) {
            ...
            return (
              this.calculateAminoSequenceMass(sequence) +
              m +
              this.N_TERMINUS +
              this.C_TERMINUS
            );
          ...
          get_losses() {
            ...
            if (this.fragmentTypes.CustomLoss.selected) {
              returnV.push({
                ...
                name: this.fragmentTypes.CustomLoss.orderNumber
                  ? "-CL" + this.fragmentTypes.CustomLoss.orderNumber.toString()
                  : "-CL",
              });
            }
            if (this.fragmentTypes.CustomLossAndGain.selected) {
              angular.forEach(
                this.fragmentTypes.CustomLossAndGain.lossesAndGains,
                function (item) {
                  returnV.push({
                    mass: -item,
          ...
          get_fragmentTypes() {
            ...
            if (this.fragmentTypes.x.selected) {
              returnV.push({
                ...
                offset:
                  ...
                  this.ChemistryConstants.O +
                  this.ChemistryConstants.C -
                  this.ChemistryConstants.H * 0, //  [C]+[M]+CO-H
              });
            }
            ...
            if (this.fragmentTypes.z.selected) {
              returnV.push({
                ...
                offset:
                  this.C_TERMINUS -
                  1 * this.ChemistryConstants.H -
                  this.ChemistryConstants.N, // [C]+[M]-NH2 // changed this
              });
            }
            if (this.fragmentTypes.a.selected) {
              returnV.push({
                ...
                offset:
                  this.N_TERMINUS -
                  this.ChemistryConstants.C -
                  this.ChemistryConstants.H -
                  this.ChemistryConstants.O, // [N]+[M]-CHO
              });
            }
            ...
            if (this.fragmentTypes.c.selected) {
              returnV.push({
                ...
                offset:
                  this.N_TERMINUS +
                  this.ChemistryConstants.N +
                  2 * this.ChemistryConstants.H, // [N]+[M]+NH2
              });
            }
            ...
            if (!this.fragmentTypes.InternalIon.selected) {
              for (var c = 1; c <= precursorCharge - 1; c++) {
                for (var i = 0; i < lengthPeptide - 1; i++) {
                  for (var frag of fragTypes) {
                    // gives an int
                    var subPeptideSub = frag.reverse
                      ? sequence.slice(lengthPeptide - i - 1, lengthPeptide)
                      : sequence.slice(0, i + 1);
                    var subPeptideMass =
                      this.calculateAminoSequenceMass(subPeptideSub);
                    var element = {};
                    ...
                    var allowedMods = frag.reverse
                      ? mods.filter((m) => {
                          return m.index >= lengthPeptide - i - 1;
                        })
                      : mods.filter((m) => {
                          return m.index < i + 1;
                        });
                    ...
                    for (var loss of losses) {
                      ...
                      if (
                        ...
                        loss.name == "-H2O" &&
                        this.countH20(subPeptideSub) > 0
                      ) {
                        let more = { ...element };
                        more["mz"] -= loss.mass / c;
                        more["neutralLoss"] = loss.name;
                        fragments.push(more);
                      } else if (loss.name == "-CO2") {
                        // co2 always
                        let more = { ...element };
                        more["mz"] -= loss.mass / c;
                        more["neutralLoss"] = loss.name;
              ...
              for (var c = 1; c <= precursorCharge - 1; c++) {
                for (var sl = 0; sl < lengthPeptide; sl++) {
                  const slicedSequence =
                    sl === 0
                      ? sequence.slice(sl, lengthPeptide)
                      : sequence.slice(sl, lengthPeptide - 1);
                  const lengthSlicedSequence = slicedSequence.length;
                  // console.log('slq: ', slicedSequence)

                  for (
                    var i = 0;
                    i <= lengthLimitCalculator(sl, lengthSlicedSequence);
                    i++
                  ) {
                    for (var frag of fragTypes) {
                      // gives an int
                      ...
                      var subPeptideSub = frag.reverse
                        ? slicedSequence.slice(
                            lengthSlicedSequence - i - 1,
                            lengthSlicedSequence
                          )
                        : slicedSequence.slice(0, i + 1);
                      ...
                      var allowedMods = frag.reverse
                        ? mods.filter((m) => {
                            return (
                              m.index >= lengthPeptide - i - 1 - sl &&
                              m.index < lengthPeptide - sl
                            );
                          })
                        : mods.filter((m) => {
                            return m.index < sl + i + 1 && m.index >= sl - 1;
                          });
      ...
      function (require, module, exports) {
        ...
        Comparator = class Comparator {
          constructor(
            ...
            spectrum_2,
            matching_type = "ppm",
            matching_tolerance = 10
          ) {
            this.spectrum_1 = spectrum_1;
            this.spectrum_2 = spectrum_2;
            this.matching_tolerance = matching_tolerance;
            let binarySpectrum_1 = binary.binary_search_spectrum(
              this.spectrum_1,
              this.spectrum_2,
              matching_type,
              matching_tolerance
            );
            let binarySpectrum_2 = binary.binary_search_spectrum(
              this.spectrum_2,
              this.spectrum_1,
              matching_type,
              matching_tolerance
            ...
            this.merged_spectrum = binary.full_merge(
              binarySpectrum_1,
              binarySpectrum_2
            );
          }
          ...
          calculate_scores1(merged_data) {
            ...
            const result = {};
            const spectral_angle =
              measures.ipsa_helper.comparison.spectral_angle(
                binarySpectrum.intensity_1,
                binarySpectrum.intensity_2
              );
            const pearson_correlation =
              measures.ipsa_helper.comparison.pearson_correlation(
                binarySpectrum.intensity_1,
                binarySpectrum.intensity_2
              );
 ...
 */
        ...
        ProForma = class ProForma {
          ...
          generateBaseSequence() {
            ...
            // notation rule 6
            const modStringWithoutMods6 = modStringWithoutMods.replace(
              /\+/g,
              ""
            );
            // notation rule 7
          ...
          parseModification() {
            ...
            while (modString.indexOf("[", 0) !== -1) {
              // if -1 we have modifications
              const positionBracketOpen = modString.indexOf("[", 0);
              const positionBracketClose = modString.indexOf("]", 0);

              // N terminus
              if (positionBracketOpen === 0) {
                const modification = modString.substring(
                  positionBracketOpen + 1,
                  positionBracketClose
                );
                const m = {
                  name: modification,
                  index: -1,
              ...
              // inside
              if (
                positionBracketOpen !== 0 &&
                modString[positionBracketOpen - 1] !== "-"
              ) {
                const modification = modString.substring(
                  positionBracketOpen + 1,
                  positionBracketClose
              ...
              if (
                ...
                let cTerminalModstring =
                  modString.substring(positionBracketOpen);

                while (cTerminalModstring.indexOf("[", 0) !== -1) {
                  // if -1 we have modifications
                  const cTerminalpositionBracketOpen =
                    cTerminalModstring.indexOf("[", 0);
                  const cTerminalpositionBracketClose =
                    cTerminalModstring.indexOf("]", 0);
                  const modification = cTerminalModstring.substring(
                    cTerminalpositionBracketOpen + 1,
                  ...
                  modifications.push(m);
                  cTerminalModstring = cTerminalModstring.substring(
                    positionBracketClose + skip
                  );
                  skip = 1;
                }
              }
              modString =
                modString.slice(0, positionBracketOpen) +
      ...
      function (require, module, exports) {
        UsiResponse = class UsiResponse {
          ...
          parseAttributes(response) {
            this.precursorCharge = parseInt(
              response.attributes.filter(
                (element) => element.name === "charge state"
              )[0].value
            );
            this.spectrum_name = response.attributes.filter(
              (element) => element.name === "spectrum name"
            )[0].value;
            this.sequence = response.attributes.filter(
              (element) => element.accession === "MS:1000888"
            )[0].value;
          }
          ...
          parseData(response) {
            switch (this.type) {
              ...
              case "peptideatlas":
                const regexp =
                  /^(\s)*(?<mz>(\d)*\.(\d)*)(\s)*(?<intensity>(\d)*\.(\d)*)/gm;
                const r = [...response.matchAll(regexp)].map((e) => ({
                  mz: parseFloat(e.groups.mz),
                  intensity: parseFloat(e.groups.intensity),
                }));

                const regexpPCM =
                  /^(\s)*PeptideIon tag: (?<peptideSequence>([A-Z]*))\/(?<precursorCharge>(\d))/gm;
                const r1 = [...response.matchAll(regexpPCM)].map((e) => ({
    ...
    5: [
      function (require, module, exports) {
        ...
        full_merge = function (spec1_spec2, spec2_spec1) {
          ...
          let splice_non_matched = non_duplicated_merged_spectrum.filter(
            (x) => x.id_1 === -1 || x.id_2 === -1
          );
          const splice_matched = non_duplicated_merged_spectrum.filter(
            (x) => x.id_1 !== -1 && x.id_2 !== -1
          );

          const spliced_matched_add = _.uniqBy(
            splice_matched.map((peakObj) => ({
              id_1: peakObj.id_1,
              intensity_1: peakObj.intensity_1,
              mz_1: peakObj.mz_1,
              id_2: -1,
          ...
          const spliced_matched_add2 = _.uniqBy(
            splice_matched.map((peakObj) => ({
              id_2: peakObj.id_2,
              intensity_2: peakObj.intensity_2,
              mz_2: peakObj.mz_2,
          ...
          const non_duplicated_merged_spectrum_without_non_matching =
            splice_matched;

          let grp1 = groupBy(
            non_duplicated_merged_spectrum_without_non_matching,
            "id_1"
          );
          ...
          grp1 = Object.values(grp1).map((objPeak) =>
            objPeak.reduce(
              (prev, current) =>
                prev.intensity_1 + prev.intensity_2 >
                current.intensity_1 + current.intensity_2
                  ? prev
                  : current,
              {}
            )
          ...
          grp1 = Object.values(grp1).map((objPeak) => {
            ...
            return objPeak.reduce(
              (prev, current) => (prev.id_2 > current.id_2 ? prev : current),
              {}
            );
          });
          ...
          grp2 = Object.values(grp2).map((objPeak) => {
            ...
            return objPeak.reduce(
              (prev, current) => (prev.id_1 > current.id_1 ? prev : current),
              {}
            );
          });

          const arr = [].concat(...grp2).map((peakObj) => ({
            id_1: peakObj.id_1,
            intensity_1: peakObj.intensity_1,
            mz_1: peakObj.mz_1,
            id_2: peakObj.id_2,
          ...
          return arr.filter(
            (v, i, a) =>
              a.findIndex((t) => t.id_1 === v.id_1 && t.id_2 === v.id_2) === i
          );
        ...
        getClosestValues_spec2_FACTORY = function (selection) {
          return function (a, x) {
            ...
            return f(a, x)
              ...
              .reduce(
                (prev, next) =>
                  Math.abs(prev[selection] - x) < Math.abs(next[selection] - x)
                    ? prev
                    : next,
                0
              );
         ...
         */
        binary_search_spectrum = function (
          spectrum_1,
          spectrum_2,
          type = "ppm",
          value = 10
        ...
        binary_full_merge = function (spectrum_1, spectrum_2) {
          ...
          to_add_2 = merge2.intensity_2.filter(
            (x, i) => merge2.intensity_1[i] === 0
          );
    ...
    6: [
      function (require, module, exports) {
        ...
        z = function (intensity_bin) {
          return {
            intensity_1:
              intensity_bin in spectrum_1_simple
                ? spectrum_1_simple[intensity_bin]
                : 0,
            intensity_2:
              intensity_bin in spectrum_2_simple
                ? spectrum_2_simple[intensity_bin]
                : 0,
          };
        };
        ...
        const ipsa_helper = {
          comparison: {
            ...
            pearson_correlation(spectrum_1, spectrum_2) {
              ...
              let xsum = 0;
              const xavg =
                spectrum_1.reduce((a, b) => a + b, 0) / spectrum_1.length;
              let ysum = 0;
              const yavg =
                spectrum_2.reduce((a, b) => a + b, 0) / spectrum_2.length;
              let sum = 0;
              let n;
              for (n = 0; n < spectrum_1.length; n++) {
        ...
        regressionThroughZero = function (ary1, ary2) {
          const maxAry1 = ary1.reduce((prev, current) =>
            prev > current ? prev : current
          ); // returns object
          const maxAry2 = ary2.reduce((prev, current) =>
            prev > current ? prev : current
          ); // returns object
