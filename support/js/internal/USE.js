...
//        .style("font-size", '13px');
      ...
      // // position the container which will hold the marked peptide sequence
      scope.container2.attr("transform", "translate(" + options.annotation.margin.left + ", " + (options.annotation.margin.top + options.offsets.bottomOffset) +  ")");
      ...
      scope.titleContainerBottom.attr("transform", "translate(" + options.interactiveTitleBottom.margin.left + ", " + options.interactiveTitleBottom.margin.top + ")");
      ...
      scope.peptideContainerBottom.attr("transform", "translate(" + (options.statisticsBottom.margin.left + options.statisticsBottom.width / 2) + ", " + options.statisticsBottom.margin.top + ")");
...
*/
    ...
    scope.drawPrecursorSummary = function() {
      ...
      datasetBottom.text(function(d) { return (d.title); })
        .attr("opacity", 0)
        .attr("transform", function(d, i) {
          if (i == 0) {
            return "translate(-" + (options.statistics.width / 2)   + ",0)";
      ...
      dataset.exit().remove();
      datasetBottom.text(function(d) { return (d.data); })
        .attr("opacity", 0)
        .attr("transform", function(d, i) {
          if (i == 0) {
            return "translate(-" + (options.statistics.width / 2 + options.statistics.margin.dataPadding_1) + ",0)";
